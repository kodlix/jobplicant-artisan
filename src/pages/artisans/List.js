              ...
              <div className="card-body p-pt-0 ">
                <div className="p-4">
                  ...
                  <header className="instant row">
                    <div className="title-container col-md-7 col-sm-12">
                      <h2 className="title sm-screen ">
                        Available hand-workers near you{" "}
                      </h2>
                    </div>
                  ...
                  <div className="row">
                        ...
                        return (
                          <div className="col-md-4 col-sm-12 highlight-card p-pb-3">
                            ...
                            >
                              ...
                              >
                                <Link to={`/applicant/${artisan.userId}`}>
                                  <p
                                    className="card-title font-weight-bold app-color"
                                    title="Click to view profile"
                                  >
                                    {`${artisan.firstName} ${artisan.lastName}`}{" "}
                                    <div className="font-weight-bold">
                                      <Tag
                                        className="p-mr-2 header-color text-nowrap text-center"
                                ...
                                <p className="card-text">
                                  ...
                                  <span className="p-p-0">
                                    ...
                                    <Rating
                                      ...
                                      stars={artisan.rating}
                                    />
                                  </span>
                                </p>
                                <p className="pt-1 d-flex flex-row-reverse">
                                  <i
                                    className="font-weight-bold pi pi-video p-pr-2"
                                    style={{ fontSize: "1.5em" }}
                                  ></i>
                                  <i
                                    className="font-weight-bold pi pi-comments p-pr-2 "
                                    style={{
                                      fontSize: "1.5em",
                                      cursor: "pointer",
                                    }}
                                    onClick={() => handleOpenChatRoom(artisan)}
                                  ></i>
                                </p>
                              </div>
                            </div>
                    ...
                    {artisans?.length === 0 && (
                      <strong className="mx-auto text-secondary">
                        oops!! There are no artisans that match your
                        description.{" "}
                      </strong>
                    )}
                  </div>

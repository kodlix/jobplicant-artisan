                    ...
                    <div>
                      ...
                      <small className="p-text-secondary">
                        {/* <div className="d-flex justify-content-between w-100">
                          ...
                          <div>
                            <p className="font-weight-bold app-color text-capitalize">Status : {jobApplied.accepted ? <Tag className='app-sec-color'> Accepted</Tag> : <Tag className='bg-warning'>Waiting to be accepted</Tag>} </p>
                          </div>
                        </div>

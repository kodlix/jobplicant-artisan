  ...
  return (
    <>
      ...
      <div className="mt-1">
        {myContacts && myContacts.length > 0 && myContacts.map((contactId, index) => {
          ...
          return (
            <div
              ...
              key={index} style={{ borderRadius: "0.5rem" }}
            >
              ...
              <div className="contacts-actionIcons">
                ...
                <i className="pi pi-video p-pr-2 font-weight-bold" style={{ fontSize: "1.5em" }} />
                <i className="pi pi-comments p-pr-2 font-weight-bold" style={{ fontSize: "1.5em" }} />
                <i
                  data-id={contact.id}
        ...
        {
          myContacts === 0 && <div className="p-card p-p-4 p-mb-2 d-flex justify-content-center" style={{ borderRadius: "0.5rem" }}>
